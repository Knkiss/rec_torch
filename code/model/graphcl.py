...
class GraphCL(model.AbstractRecModel):
    def __init__(self):
        super().__init__()
        self.graph_1 = None
        self.graph_2 = None
    ...
    def calculate_embedding(self):
        return self.qkv(self.embedding_user.weight, self.embedding_item.weight, self.Graph)

    def calculate_loss(self, users, pos, neg):
        loss = {}
        all_users, all_items = self.calculate_embedding()
        users_1, items_1, users_2, items_2 = self.sgl(self.embedding_user.weight, self.embedding_item.weight,
